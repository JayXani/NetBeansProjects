...
public class TelaEscolhaQuarto extends javax.swing.JInternalFrame {
    ...
    ArrayList<Clientes> hospedeNovo;
    ReservaQuarto informacoesQuarto;
    LocalDate checkIn;
    LocalDate checkOut;
            ...
            if ((dayCheckin.getSelectedItem().equals("DIA")) || (monthCheckin.getSelectedItem().equals("MÊS")) || (yearCheckin.getSelectedItem().equals("ANO"))) {
                ...
                if ((dayCheckOut.getSelectedItem().equals("DIA")) || (monthCheckOut.getSelectedItem().equals("MÊS")) || (yearCheckOut.getSelectedItem().equals("ANO"))) {
                    ...
                    if (confirmacao == JOptionPane.NO_OPTION) {
                        ...
                        informacoesQuarto = new ReservaQuarto(hospedeNovo, camasSelecionadas, frigobar, sacada, banheiroPrivativo, tv, setDiaria(), checkIn, checkOut);
                    
                        JOptionPane.showMessageDialog(null, "RESERVA CONCUÍDA ! \n\nCaso deseje verificar sua reserva, vá até o canto"
                                + "superior esquerdo do menu e clique em \"Verificar reserva.\"");
                        this.dispose();
    ...
    public double setDiaria() {
        double precoDiaria = 350.00;
